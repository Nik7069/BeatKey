...
template <> constexpr inline auto SettingsDialog::qt_create_metaobjectdata<qt_meta_tag_ZN14SettingsDialogE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "settingsChanged",
        "",
        "onPrimaryKeyButtonClicked",
        "onSecondaryKeyButtonClicked",
        "onButtonBoxClicked",
        "QAbstractButton*",
        "button"
    };
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'onPrimaryKeyButtonClicked'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onSecondaryKeyButtonClicked'
        QtMocHelpers::SlotData<void()>(4, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onButtonBoxClicked'
...
void SettingsDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onPrimaryKeyButtonClicked(); break;
        case 2: _t->onSecondaryKeyButtonClicked(); break;
        case 3: _t->onButtonBoxClicked((*reinterpret_cast<std::add_pointer_t<QAbstractButton*>>(_a[1]))); break;
        default: ;
        }
    }
